...
<html lang="en">
	<head>
		...
		<link rel="icon" href="<?php echo base_url('assets/images/unidalogo.png') ?>" type="image/ico" />

		<title>Apotek UNIDA</title>
			...
			<div class="main_container">
				...
				<footer>
					<div class="pull-right">
						<a>faturachman.ahmad@unida.ac.id</a>
						<br>
						<a>powered by codeigniter 3</a>
					</div>
			        <div class="clearfix"></div>
				</footer>
				<!-- /Footer Content -->
...
<script type="text/javascript">
    ...
    var counter = 1;
          ...
          $('#addRow').on( 'click', function () {
            transaksi.row.add( [
              '<select required="required" style="width:100%;" class="form-control nama_obat" id="nama_obat'+counter+'" name="nama_obat[]" data-stok="#stok'+counter+'" data-unit="#unit'+counter+'" data-harga_jual="#harga_jual'+counter+'"><option selected="true" value="" disabled >pilih obat</option><?php foreach($get_med as $gm){ ?><option value="<?php echo $gm; ?>"><?php echo $gm; ?></option><?php  }?></select>',
              '<input id="stok'+counter+'" name="stok[]" class="form-control stok"  >',
              '<input id="unit'+counter+'" name="unit[]" class="form-control" >',
              '<input id="harga_jual'+counter+'" name="harga_jual[]" class="form-control harga_jual" >',
          ...
          $('#prod').on("click", "#removeproduk", function(){
            ...
            transaksi.row($(this).parents('tr')).remove().draw(false);
            updateTotal();
          });
...
<script type="text/javascript">
    ...
    var count = 1;
          ...
          $('#addpurchase').on( 'click', function () {
            ...
            purchase.row.add( [
              '<select required="required" style="width:100%;" class="form-control nama_obat" id="nama_obat'+count+'" name="nama_obat[]" data-stok="#stok'+count+'" data-unit="#unit'+count+'" data-harga_beli="#harga_beli'+count+'"><option selected="true" value="" disabled >Pilih obat</option><?php foreach($get_med as $gm){ ?><option value="<?php echo $gm; ?>"><?php echo $gm; ?></option><?php  }?></select>',

              '<input id="stok'+count+'" name="stok[]" class="form-control stok"  >',
              '<input id="unit'+count+'" name="unit[]" class="form-control unit" >',
              '<input id="harga_beli'+count+'" name="harga_beli[]" class="form-control harga_beli">',
